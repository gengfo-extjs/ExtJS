...
2. Run gridentity.example.CreateDatabase to drop and create tables
3. Run gridentity.example.StartCacheServer
4. Run gridentity.example.InsertExample to persist some objects
5. Run gridentity.example.QueryExample to query objects
