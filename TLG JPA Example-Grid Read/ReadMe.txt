...
2. Run gridread.example.CreateDatabase to drop and create tables
3. Run gridread.example.StartCacheServer
4. Run gridread.example.InsertExample to persist some objects
5. Run gridread.example.QueryExample to query objects
