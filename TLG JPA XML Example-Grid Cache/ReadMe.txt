...
2. Run gridcache.xml.example.CreateDatabase to drop and create tables
3. Run gridcache.xml.example.StartCacheServer
4. Run gridcache.xml.example.InsertExample to persist some objects
5. Run gridcache.xml.example.QueryExample to query objects
